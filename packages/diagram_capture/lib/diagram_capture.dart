...
class _DiagramFlutterBinding extends BindingBase with GestureBinding, ServicesBinding, SchedulerBinding, PaintingBinding, RendererBinding, WidgetsBinding {
  @override
  void initInstances() {
    super.initInstances();
...
typedef File AnimationFilenameGenerator();
...
class DiagramController {
  ...
  DiagramController({
    ...
    AnimationFilenameGenerator frameFilenameGenerator,
    double pixelRatio: 1.0,
    Size screenDimensions: _kDefaultDiagramViewportSize,
  }) {
    _filenameGenerator = frameFilenameGenerator ?? _basicFilenameGenerator;
  ...
  /// is determined by [metadataFilenameGenerator]. Names produced by the
  /// [metadataFilenameGenerator] should have the same basename prefix as the
  /// frame filenames.
  ///
