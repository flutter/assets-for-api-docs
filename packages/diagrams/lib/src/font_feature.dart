...
abstract class SideBySideFontFeatureDiagram<T> extends FontFeatureDiagram<T> {
  ...
  Widget buildSubEntry(BuildContext context, T entry, {bool enable = true}) =>
      Expanded(
        child: Stack(
          children: <Widget>[
            Positioned.fill(
...
class CharacterVariantsFontFeatureDiagram
  ...
  @override
  Widget buildEntry(BuildContext context, String entry, {bool enable = true}) =>
      Text(
        demos[entry]!,
        style: textStyle.copyWith(
          fontFamily: font,
...
class StylisticSetsFontFeatureDiagram2 extends FontFeatureDiagram<int> {
  ...
  String describe(int entry) {
    switch (entry) {
      case 0x00:
        return 'no stylistic sets enabled';
      case 0x01:
        return 'only ss01 enabled';
      case 0x02:
        return 'only ss02 enabled';
      case 0x03:
        return 'ss01 and ss02 enabled';
    }
