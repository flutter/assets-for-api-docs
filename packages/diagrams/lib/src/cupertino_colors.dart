...
List<Map<String, CupertinoDynamicColor>>
activeColors = <Map<String, CupertinoDynamicColor>>[
...
List<Map<String, CupertinoDynamicColor>>
systemColors1 = <Map<String, CupertinoDynamicColor>>[
...
List<Map<String, CupertinoDynamicColor>>
systemColors2 = <Map<String, CupertinoDynamicColor>>[
...
class CupertinoColorsDiagram extends StatelessWidget with DiagramMetadata {
  ...
  Widget build(BuildContext context) {
    final TextStyle textStyle = CupertinoTheme.of(
      context,
    ).textTheme.tabLabelTextStyle.copyWith(fontSize: 14.0);
            ...
            for (final Map<String, CupertinoDynamicColor> backgroundColor
              ...
              TableRow(
                children: <Widget>[
                  ...
                  ColorWidget(
                    color: backgroundColor.values.first.darkHighContrastColor,
                  ),
                ],
              ),
          ],
          ...
          child: Row(
            children: <Widget>[
              const Column(
                ...
                children: <Widget>[Text('R'), Text('G'), Text('B')],
              ),
