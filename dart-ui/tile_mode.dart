...
void main() {
  ...
  new Timer(const Duration(seconds: 1), () {
    ...
    double x = left;
    double y = top;
    print('convert \$FILE -crop ${w}x$h+$x+$y -resize \'200x200>\' tile_mode_clamp_linear.png');
    x += xStride;
    print('convert \$FILE -crop ${w}x$h+$x+$y -resize \'200x200>\' tile_mode_clamp_radial.png');
    x = left;
    y += yStride;
    print('convert \$FILE -crop ${w}x$h+$x+$y -resize \'200x200>\' tile_mode_repeated_linear.png');
    x += xStride;
    print('convert \$FILE -crop ${w}x$h+$x+$y -resize \'200x200>\' tile_mode_repeated_radial.png');
    x = left;
    y += yStride;
    print('convert \$FILE -crop ${w}x$h+$x+$y -resize \'200x200>\' tile_mode_mirror_linear.png');
    x += xStride;
    print('convert \$FILE -crop ${w}x$h+$x+$y -resize \'200x200>\' tile_mode_mirror_radial.png');
  });
}
